...
class AnalogOscillator {
 public:
  ...
  virtual void set_shape(AnalogOscillatorShape shape) = 0;

  virtual void set_pitch(int16_t pitch) = 0;

  virtual void set_parameter(int16_t parameter) = 0;

  virtual void set_aux_parameter(int16_t parameter) = 0;

  virtual uint32_t phase_increment() = 0;
...
extern "C" {
braids::AnalogOscillator * brds_factory_analog();
//brds::DigitalOscillator * brds_factory_digital();
}
#endif
